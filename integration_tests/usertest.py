...
class UserTest(TestCase):
    ...
    def setUpClass():
        UserHandler.Session = DBInitializer.get_session
        UserHandler.user_validation = user_validation
        UserHandler.email_validation = email_validation
    ...
    def test_create_and_get_user(self):
        user = User(first_name='first name', last_name='last name', phone='9121234567', email='email@domain.tld')
        # print(user)
